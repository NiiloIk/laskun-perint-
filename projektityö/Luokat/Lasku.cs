...
namespace projektityö.Luokat
{
    internal class Lasku
    {
        ...
        public DateOnly Eräpäivä { get; set; }
        public DateOnly? Maksupäivä { get; set; }
        ...
        public void AsetaMaksupäivä(DateOnly? maksupäivä)
        {
            if (maksupäivä == null)
            {
                maksupäivä = DateOnly.FromDateTime(DateTime.Now);
            }
